    ...
    .post(
        ...
        async ({
            ...
            try {
                ...
                savedFile.fileName = truncateFileName(savedFile.fileName, MAX_FILENAME_LENGTH);
    ...
    .delete(
        ...
        async ({
            ...
            try {
                ...
                // Shorten fileName if necessary
                removeFile.fileName = truncateFileName(removeFile.fileName, MAX_FILENAME_LENGTH);
